...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="<?php echo base_url('assets/user/css/animate.css'); ?>" rel="stylesheet" type="text/css" media="all">
    <!-- Custom Theme files -->
    <script src="<?php echo base_url('assets/user/js/jquery-1.12.0.min.js')?>"></script>
